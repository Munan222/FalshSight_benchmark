...
class KTHDataset(object):
    ...
    def __init__(self, KTH_dir, transform, train, val,
                ...
                #  actions=['boxing', 'handclapping', 'handwaving', 'jogging_no_empty', 'running_no_em`pty', 'walking_no_empty'], 
                 actions=['boxing'], 
                 val_person_ids = None
                 ):
        """
        ...
        if self.train:
            ...
            # self.person_ids = list(range(1, 3))
            self.person_ids = list((1,3,5,7))
            ...
            # self.person_ids = list(range(3, 5))
            # self.person_ids = list((2,4,6,8))
            self.person_ids = list(range(25, 27))
